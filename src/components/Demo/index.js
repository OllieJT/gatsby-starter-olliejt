        ...
        <Container restrict as="section" anchor="embedded">
          ...
          <article id="embedded__images">
            ...
            <div>
              ...
              <p><img src="http://placekitten.com/480/480" alt="Description of this visual thing"/></p>
              <h3>Wrapped in a <code>&lt;figure&gt;</code> element, no <code>&lt;figcaption&gt;</code></h3>
              <figure><img src="http://placekitten.com/420/420" alt="Description of this visual thing"/></figure>
          ...
          <article id="embedded__meter">
            ...
            <div><meter defaultValue="2" min="0" max="10">2 out of 10</meter></div>
            <footer><p><a href="#top">[Top]</a></p></footer>
          </article>
          ...
          <form>
            ...
            <fieldset id="forms__checkbox">
              ...
              <li>
                <label htmlFor="checkbox1">
                  <input id="checkbox1" name="checkbox" type="checkbox" defaultChecked /> Choice A</label></li>
              <li><label htmlFor="checkbox2">
              <input id="checkbox2" name="checkbox" type="checkbox" defaultChecked={false}/> Choice B</label></li>
                <li><label htmlFor="checkbox3">
                  <input id="checkbox3" name="checkbox" type="checkbox" defaultChecked={false}/> Choice C</label></li>
              </ul>
            </fieldset>
            <p><a href="#top">[Top]</a></p>
            <fieldset id="forms__radio">
              ...
              <ul>
                ...
                <li><label htmlFor="radio2"><input id="radio2" name="radio" type="radio" defaultChecked={false}/> Option 2</label></li>
                <li><label htmlFor="radio3"><input id="radio3" name="radio" type="radio" defaultChecked={false}/> Option 3</label></li>
              </ul>
            </fieldset>
            <p><a href="#top">[Top]</a></p>
